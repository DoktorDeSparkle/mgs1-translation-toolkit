...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        palette = QPalette()
        brush = QBrush(QColor(120, 200, 140, 255))
        ...
        self.previewFrame.setFrameShape(QFrame.Shape.NoFrame)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionQuit.setText(QCoreApplication.translate("MainWindow", u"⏻︎ Quit", None))
#if QT_CONFIG(shortcut)
        ...
        self.actionPasta.setText(QCoreApplication.translate("MainWindow", u"📋 Paste", None))
        ...
        self.playVoxButton.setText(QCoreApplication.translate("MainWindow", u"⏵︎ Play Audio", None))
#if QT_CONFIG(shortcut)
        ...
        self.quitButton.setText(QCoreApplication.translate("MainWindow", u"⏻︎ Quit", None))
